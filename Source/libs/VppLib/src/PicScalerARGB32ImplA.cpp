...
extern "C" void ScaleRowAsmARGB32(void *pDst, unsigned _widthOut, void * const * pSrcRows, unsigned _widthIn);
...
*/
int PicScalerARGB32Impl::Scale(void* pOutImg, const void* pInImg, bool VFlip)
{
